...
(1, '12345678', 'ГБОУ средняя общеобразовательная школа № XXX', 'XXX района Санкт-Петербурга', '', 'директор школы', 'Иванов Иван Иванович', 'https://example.ru', '0123456789', 0, 0, 255);
